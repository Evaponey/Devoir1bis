...
public class frmPrincipal extends javax.swing.JFrame {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnNbAnnees, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnNbAnneesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNbAnneesActionPerformed
        double coutsFinal=150;
        double anneeSup=0;
        double annne=0;
        int TotalBenef=0;
        int pourcen;
        double pourcent = 20/100;
      
        
        // TODO add your handling code here:
        
        while (TotalBenef<=coutsFinal)
  {
       TotalBenef=(int) (TotalBenef+anneeSup);
      anneeSup=anneeSup*pourcent;
      anneeSup++;
  }  
  {           
      lblNbSemaines.setText("annees");
   }   
    ...
    private void txtNbBugsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNbBugsActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this, "Veuillez saisir le nombre de bug corigés");
       
        {
            if(txtNbAnnees.getValue<4)
            {
                lblPrime.setText("Vous percevez une prime de 300euros ");
                
            }
            else
            {
               lblPrime.setText("Vous percevez une prime de 300euros + 30euros par année supplémantaire ");
               
            
             btnCalculerPrime=(0,04*txtNbBugs)+(txtNbAnnees*30)
    ...
    private void btnTriangleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTriangleActionPerformed
        ...
        DefaultTableModelTriangle=(DFT)tblTriangle.getModel();
